...
INSERT INTO element (type, name, description, thumbnail_file_id) VALUES ('portfolio', 'Portfolio de Juanjo','Soy Juanjo y este es mi portfolio', 1);
INSERT INTO element (type, name, description, thumbnail_file_id) VALUES ('tab', 'Tab 1','Description for Element Group 1', 1);
INSERT INTO element (type, name, description, thumbnail_file_id) VALUES ('project', 'project 1','Description for Element Group 1', 1);
